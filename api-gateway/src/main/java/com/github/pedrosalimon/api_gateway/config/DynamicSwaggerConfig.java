package com.github.pedrosalimon.api_gateway.config;
...
public class DynamicSwaggerConfig {
    ...
    public DynamicSwaggerConfig(DiscoveryClient discoveryClient, SwaggerUiConfigProperties swaggerUiConfigProperties) {
